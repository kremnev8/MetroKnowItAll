    ...
    public class UIAchievementPopup : MonoBehaviour
    {
        ...
        public static void UnlockAchievement(string key)
        {
            try
            {
                ...
                Achievement achievement = model.achievementsPopup.achievementData.Get(key);
                if (!model.statistics.current.unlockedAchievements.IsUnlocked(achievement))
                {
                    ...
                    model.achievementsPopup.Popup(achievement);
                }
        ...
        public void Popup(Achievement achievement)
        {
            ...
            achievementIcon.color = achievement.spriteTint;
